      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-dark border border-gray-700 rounded-lg px-4 py-2 focus:outline-none focus:border-neonCyan transition"
                />
              </div>
              <div>
              ...
              <button 
                ...
                className="w-full bg-neonCyan/10 text-neonCyan border border-neonCyan hover:bg-neonCyan/20 transition py-3 rounded-lg flex justify-center items-center gap-2 font-bold disabled:opacity-50"
              >
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}>
            {analysis ? (
              <div className="bg-darker p-6 rounded-xl border border-orange-500/30 shadow-[0_0_20px_rgba(249,115,22,0.1)]">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-2"><Sparkles className="text-orange-500" /> AI Insights</h3>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-dark p-4 rounded-lg border border-gray-800">
                    ...
                    <p className="text-2xl font-bold text-neonCyan">{analysis.expectedWeightage || 0}%</p>
                  </div>
                  <div className="bg-dark p-4 rounded-lg border border-gray-800">
               ...
               <div className="h-full flex flex-col items-center justify-center text-gray-500 bg-darker rounded-xl border border-gray-800 border-dashed">
